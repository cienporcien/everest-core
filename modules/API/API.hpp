...
struct Conf {
    ...
    int hw_caps_max_gun_temperature_C_decimal_places;
    ...
    int telemetry_gun_temperature_C_decimal_places;
    ...
    double hw_caps_max_gun_temperature_C_round_to;
    ...
    double telemetry_gun_temperature_C_round_to;
};
