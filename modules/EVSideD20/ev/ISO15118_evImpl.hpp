...
public:
    ...
    ISO15118_evImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<EVSideD20>& mod, Conf& config) :
...
protected:
    ...
    virtual bool handle_start_charging(types::iso15118_ev::EnergyTransferMode& EnergyTransferMode) override;
    ...
    virtual void handle_set_dc_params(types::iso15118_ev::DC_EVParameters& EV_Parameters) override;
    virtual void handle_set_bpt_dc_params(types::iso15118_ev::DC_EV_BPT_Parameters& EV_BPT_Parameters) override;
...
private:
    const Everest::PtrContainer<EVSideD20>& mod;
    const Conf& config;
